...
An approved ticket's durable Approved test seams section is that confirmation;
reuse it without asking again. During headless execution, missing or conflicting
approval is needs-info. An approved no-new-tests decision is valid for changes
where a new test would not provide meaningful behavioral evidence.
