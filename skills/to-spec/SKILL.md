...
3. Write the spec using the template below. For local storage use
   <workflow-root>/backlog/<feature>/spec.md. For hosted storage publish the spec
   as a planning artifact, without a ready-for-agent label. It is not an executable
   ticket; to-tickets creates the backlog and triage establishes readiness.
